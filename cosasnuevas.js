...
const resultadoObtenido=  final>=18 ? final.innerHTML="felicidades aprobastes " :final.innerHTML="no aprobastes"

 
   document.getElementById8("resultadoObtenido").innerHTML=resultadoObtenido
}*/


function notificacionFinal( ){
    let final =document.getElementById("final").value;
    let resultado =final >=18 ?final.innerHTML="estas aprobado":final.innerHTML="no estas aprobado "
    //final >=18?final.innerHTML="estas aprobado":final.innerHTML="no estas aprobado "
     document.getElementById("resultadoObtenido").innerText="  y resultado es   " + resultado;
    }
